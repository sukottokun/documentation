...
2.  Name your site. 
    ...
    <p markdown="1">The site name will be prefixed to all [Platform URLs](/docs/platform-domains), which are automatically configured as subdomains of `pantheonsite.io`. Site names and Platform URLs are permanent and cannot be changed.
    </p></div>
